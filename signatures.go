...
var YaraRulesets = []YaraRulesetDef{
	{"yara-forge",
		"YARA Forge core -- 5000+ curated rules from 39 sources (Neo23x0, Malpedia, SEKOIA, etc.)",
		"https://github.com/YARAHQ/yara-forge/releases/latest/download/yara-forge-rules-core.zip",
		0, []string{"**/*.yar", "**/*.yara", "*.yar", "*.yara"}, "zip"},
	{"signature-base",
		"Neo23x0/Florian Roth -- webshells, exploits, APT tools (updated daily)",
		"https://github.com/Neo23x0/signature-base/archive/refs/heads/master.tar.gz",
		1, []string{"yara/*.yar"}, ""},
	{"php-malware-finder",
		"jvoisin -- semantic PHP malware detection rules",
		"https://github.com/jvoisin/php-malware-finder/archive/refs/heads/master.tar.gz",
		1, []string{"php-malware-finder/rules/*.yar", "rules/*.yar", "**/*.yar"}, ""},
	{"reversinglabs",
	...
	{"elastic",
		...
		1, []string{"yara/**/*.yar"}, ""},
	{"volexity",
		"Volexity threat intel -- webshells, APT, exploitation chains",
		"https://github.com/volexity/threat-intel/archive/refs/heads/main.tar.gz",
		1, []string{"**/*.yar", "**/*.yara"}, ""},
}
