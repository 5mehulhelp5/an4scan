...
var MagentoCVEs = []MagentoCVEDef{
	...
	{"CVE-2024-45115", CRITICAL,
		...
		[]string{"2.4.7-p3", "2.4.6-p8", "2.4.5-p10", "2.4.4-p11"}},
	{"CVE-2024-45148", HIGH,
		"Insecure Direct Object Reference (IDOR) - account takeover",
		"APSB24-73 / Upgrade to 2.4.7-p3+",
		[]string{"2.4.7-p3", "2.4.6-p8", "2.4.5-p10", "2.4.4-p11"}},
	{"CVE-2024-45116", CRITICAL,
	...
	{"CVE-2024-39397", CRITICAL,
		...
		[]string{"2.4.7-p2", "2.4.6-p7", "2.4.5-p9", "2.4.4-p10"}},
	{"CVE-2024-39398", HIGH,
	...
	{"CVE-2024-39399", HIGH,
		...
		"APSB24-61 / Upgrade to 2.4.7-p2+",
		[]string{"2.4.7-p2", "2.4.6-p7", "2.4.5-p9", "2.4.4-p10"}},
	{"CVE-2024-39401", CRITICAL,
		"OS Command Injection - authenticated RCE",
		"APSB24-61 / Upgrade to 2.4.7-p2+",
		[]string{"2.4.7-p2", "2.4.6-p7", "2.4.5-p9", "2.4.4-p10"}},
	{"CVE-2024-39402", CRITICAL,
	...
	{"CVE-2024-34102", CRITICAL,
		...
		[]string{"2.4.7-p1", "2.4.6-p6", "2.4.5-p8", "2.4.4-p9"}},
	{"CVE-2024-20720", CRITICAL,
		"OS Command Injection via crafted layout template (ACTIVELY EXPLOITED)",
		"APSB24-03 / Upgrade to 2.4.6-p4+",
		[]string{"2.4.6-p4", "2.4.5-p6", "2.4.4-p7"}},
...
// vendorSkipSigs are heuristic signatures with a high false-positive rate in
// composer libraries — disabled under vendor/. Strong signatures (BD-001..007,
// CC-*, ML-001/002) remain active everywhere.
var vendorSkipSigs = map[string]bool{
	"BD-008": true, "BD-013": true, "BD-014": true, "BD-015": true,
	"ML-003": true, "OB-001": true, "OB-004": true, "OB-008": true,
	"MG-003": true,
}

var SkipDirs = map[string]bool{
	".git": true, "node_modules": true, ".svn": true, ".hg": true,
	// Compiled template copies (sources are scanned in app/ and vendor/)
	"view_preprocessed": true,
	// Magefan Zero Downtime Deployment staging copy (full duplicate instance)
	"mfzerodwt": true,
}
...
var WhitelistPaths = []string{
	...
	// MagicToolbox (MagicZoom/MagicScroll: legitimate packed/eval'd JS)
	"app/code/MagicToolbox/",
